...
import com.alphatek.tylt.web.servlet.mvc.model.validate.validators.FieldMatchValidator;
...
public @interface FieldMatch {
	...
	String message() default "{com.alphatek.tylt.web.servlet.mvc.model.validate.constraints.FieldMatch.message}";
