 ...
 */
@Component
public final class CountryValidator implements ConstraintValidator<com.alphatek.tylt.web.servlet.mvc.model.validate.constraints.Country, Country> {
	@Resource private CountryDao countryDao;

	@Override public void initialize(com.alphatek.tylt.web.servlet.mvc.model.validate.constraints.Country constraintAnnotation) {}
