...
<html lang="en">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="../../../resources-build/<spring:theme code="styles" />/theme.css" />
		<link type="text/css" rel="canonical" href="" />
		<link type="image/x-icon" rel="icon" href="../../../resources/<spring:theme code="images" />/favicon.ico" />

		<script src="../../../resources/build/scripts/main.js" data-main="../../../resources-build/scripts/main"></script>
	</head>
	<body>
	  <div id="wrap">
