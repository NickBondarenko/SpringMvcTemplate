(function($, exports, undefined) {
  ...
  $.each(overwrite, function(idx, method) {
    ...
    $.fn[method] = function() {
      var args  = $.makeArray(arguments);
      var nodes = _extractNodes.apply(this, args);
  ...
  var build = function(fn) {
    ...
    return fn ? _to$(fn.call(this, this) || this.root()) : this;
  };
  ...
  Buildr.prototype.defineTag(
    'a','abbr','acronym','address','article','aside','audio','b','bdi','bdo','big','blockquote','body','button','caption',
    'canvas','command','cite','code','colgroup','datalist','dd','del','details','dfn','div','dl','dt','em','embed','fieldset',
    'figcaption','figure','footer','form','frameset','h1','h2','h3','h4','h5','h6','head','header','hgroup','html','i','iframe',
    'ins','keygen','kbd','label','legend','li','map','mark','meter','nav','noframes','noscript','object','ol','optgroup','option',
    'output','p','pre','progress','q','rp','rt','ruby','samp','section','script','select','small','source','span','strong','style',
    'sub','summary','sup','table','tbody','td','textarea','tfoot','thead','time','title','tr','track','tt','ul','var','video','wbr',
  ...
  var element = {
    ...
    'class': function(classes) {
      return this.removeClass().addClass(classes);
    },
    nest: function() {
      var $el = this,
        bldr = this.buildr(),
      ...
      var processArg = function(arg) {
        ...
        } else if (_instanceOf(arg, jQuery)) { //inner element
          $el.append(arg);
  ...
  $.fn.buildr = function() {
    return this.append($.buildr.apply($.buildr, $.makeArray(arguments)));
  };
