define(['es5', 'es6', 'js.extensions', 'modernizr', 'modernizr.tests', 'jquery', 'jquery-ui', 'bootstrap', 'jquery.showtime', 'utilities'], function(es5, es6, jsExtensions, Modernizr, modernizrTests, $) {
